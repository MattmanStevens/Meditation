...
#define ORIGINAL_FILE_NAME "UE4Editor-Meditation_VR_1-Win64-DebugGame.dll"
#define UE_IS_ENGINE_MODULE 0
#define UE_BUILD_DEVELOPMENT_WITH_DEBUGGAME 1
#define UE_PROJECT_NAME Meditation_VR_1
...
#define MEDITATION_VR_1_API DLLEXPORT
